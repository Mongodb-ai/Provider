...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003299363200'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003299363200'))
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003299363200'))
...
FILES_DATABASE = environ.get('DATABASE_URI')
...
START_IMG = (environ.get('START_IMG', 'https://files.catbox.moe/8a4tuu.jpg https://files.catbox.moe/cwzryd.jpg https://files.catbox.moe/3q4ofc.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://files.catbox.moe/0jw0q4.jpg')).split()
